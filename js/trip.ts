...
window.addEventListener("load", (): void => {
  ...
  const tripApiData: {
    ...
    },
    {
      링크: "#",
      이미지:
        "https://media.interparkcdn.net/interpark-tour/f_auto/w_450,h_380,q_auto,c_auto/tourimage/product/tour/00161/A60/500/A6020752_1_257.jpg",
      alt: "여행상품",
      대상: "아이",
      상품타이틀:
