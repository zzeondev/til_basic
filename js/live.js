window.addEventListener("load", function () {
  ...
  const liveApiData = [
    ...
    },
    {
      ...
      디테일정보: "강릉 세인트존스호텔 73% 118,080원",
    },
    {
      uid: 11,
      링크: "#",
      이미지: "images/live_11.png",
      방송: "라이브 다시보기",
      상품타이틀: "[파르나스 호텔 제주] 설레는 경험 럭셔리 호텔 특가",
      날짜: "",
      시간: "",
      디테일이미지: "images/live_11_1.jpg",
      디테일정보: "파르나스 호텔 제주 66% 262,800원",
    },
    {
      uid: 12,
      링크: "#",
      이미지: "images/live_12.png",
      방송: "라이브 다시보기",
      상품타이틀: "[여수 오션뷰 특집] 낭만의 도시 여수로 떠나는 여름 휴가!",
      날짜: "",
      시간: "",
      디테일이미지: "images/live_12_1.jpg",
      디테일정보: "여수 디오션 호텔&리조트 66% 72,900원",
    },
  ];
  // html 태그 만들고 배치
